...
<body>
    ...
    <div class="container">
        ...
        <table id="dg" class="easyui-datagrid" title="DataGrid with Toolbar" style="width:700px;height:250px"
                data-options="singleSelect:true,url:'teste.json',method:'get',toolbar:toolbar">
            <thead>
                <tr>
